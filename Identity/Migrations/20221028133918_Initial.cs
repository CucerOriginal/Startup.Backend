        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 3, "Аниме́  — японская мультипликация. В отличие от мультфильмов других стран, предназначенных в основном для просмотра детьми, бо́льшая часть выпускаемого аниме рассчитана на подростковую и имеет высокую популярность в мире. ", "Аниме" },
                    { 4, "Ну, тут очевидно про кино и сериалы, да?", "Кино и сериалы" },
                    { 5, "Всем небезразличным к шаурме посвящается", "Шаурма и друзья" },
                    { 6, "Путеше́ствие — передвижение по какой-либо территории или акватории с целью их изучения, а также с общеобразовательными, познавательными, спортивными и другими целями.", "Путешествия" },
                    { 7, "этот вид «отражает действительность и воздействует на человека посредством осмысленных и особым образом организованных по высоте и во времени звуковых последований", "Музыка" },
                    { 8, "одна из наиболее общих категорий эстетики, искусствознания и художественной практики", "Арт" },
                    { 9, "единица значимой для культуры информации.", "Мемы" },
                    { 10, "под культурой понимают человеческую деятельность в её самых разных проявлениях, включая все формы и способы человеческого самовыражения и самопознания", "Культура" },
                    { 11, "форма деятельности в условных ситуациях, направленная на воссоздание и усвоение общественного опыта, фиксированного в социально закрепленных способах осуществления предметных действий, в предметах науки и культуры.", "Игры" }
                });
